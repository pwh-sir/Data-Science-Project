...
Cookie = 'SCF=AqkvlZ5aMIWela20LiBIJJvy4xUgUtIl10JJVzpO2l1zeUpnCVEIXTaApJ2qc9jDWDc7GuoOEVbpqLiAAM072Qw.; _T_WM=69892263586; MLOGIN=0; SUB=_2A25NDtsXDeRhGeFL7lAZ9yvJzjmIHXVu8OVfrDV6PUJbktAKLRTNkW1NfeJ6TR26YBTUbCd6-KlAgwROJxrr6ejf; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9W57.KikSs2Wp_XvzJAv5F5V5NHD95QNSK-E1hMfSK-fWs4DqcjMi--NiK.Xi-2Ri--ciKnRi-zNeKzpehzXeon4entt; SSOLoginState=1611311943; M_WEIBOCN_PARAMS=luicode%3D20000174'
...
if __name__ == '__main__':
    ...
    # start_time + 8hour
    start_time, end_time = '2020-06-10-00', '2020-06-20-22'
    if start_time >= end_time:
        raise Exception('start_time 必须小于 end_time')
